...
#     ax.set_title("Actual vs. Measured Object Length")
#     ax.legend()
#     fig.tight_layout()
#     fig.savefig(os.path.join(out_dir, "error_by_object.png"), dpi=150)
#     plt.close(fig)
...
#     # percent error per object
#     fig, ax = plt.subplots(figsize=(10, 5))
#     ax.bar(x, df["pct_error"], color="indianred")
#     ax.axhline(df["pct_error"].mean(), color="black", linestyle="--", label="mean % error")
#     ax.set_xticks(x)
#     ax.set_xticklabels(df["object_id"].astype(str), rotation=45, ha="right")
#     ax.set_ylabel("Percent error (%)")
#     ax.set_title("Percent Error per Object")
#     ax.legend()
#     fig.tight_layout()
#     fig.savefig(os.path.join(out_dir, "percent_error.png"), dpi=150)
#     plt.close(fig)
